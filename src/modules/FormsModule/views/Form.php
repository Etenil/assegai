...
namespace etenil\assegai\modules\forms;
...
class Form
{
    ...
    {
        $fieldname = 'etenil\assegai\modules\forms\fields\\' . $type . 'Field';
        $field = new $fieldname;
        $field->name($name);
    ...
    public function isValid(array $data)
    {
        foreach($this->_fields as $fieldname => $field) {
            ...
            if(!$r->isSubclassOf('etenil\assegai\modules\forms\fields\Field')) {
                continue;
            }
